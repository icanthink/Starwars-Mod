...
import net.icanthink.spacemod.procedure.ProcedureSaveSlot2KeybindOnKeyPressed;
import net.icanthink.spacemod.SpaceMod;
import net.icanthink.spacemod.ElementsSpaceMod;

@ElementsSpaceMod.ModElement.Tag
public class KeyBindingSaveSlot2Keybind extends ElementsSpaceMod.ModElement {
	private KeyBinding keys;
	public KeyBindingSaveSlot2Keybind(ElementsSpaceMod instance) {
		super(instance, 53);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.saveslot2keybind", Keyboard.KEY_K, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSaveSlot2KeybindOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}

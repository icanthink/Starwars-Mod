...
import net.icanthink.spacemod.procedure.ProcedureInstantAbilityKeybindOnKeyPressed;
import net.icanthink.spacemod.SpaceMod;
import net.icanthink.spacemod.ElementsSpaceMod;

@ElementsSpaceMod.ModElement.Tag
public class KeyBindingInstantAbilityKeybind extends ElementsSpaceMod.ModElement {
	private KeyBinding keys;
	public KeyBindingInstantAbilityKeybind(ElementsSpaceMod instance) {
		super(instance, 48);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.instantabilitykeybind", Keyboard.KEY_0, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureInstantAbilityKeybindOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}

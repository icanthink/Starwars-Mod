...
import net.icanthink.spacemod.procedure.ProcedureSaveSlot3KeybindOnKeyPressed;
import net.icanthink.spacemod.SpaceMod;
import net.icanthink.spacemod.ElementsSpaceMod;

@ElementsSpaceMod.ModElement.Tag
public class KeyBindingSaveSlot3Keybind extends ElementsSpaceMod.ModElement {
	private KeyBinding keys;
	public KeyBindingSaveSlot3Keybind(ElementsSpaceMod instance) {
		super(instance, 54);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.saveslot3keybind", Keyboard.KEY_L, "key.categories.misc");

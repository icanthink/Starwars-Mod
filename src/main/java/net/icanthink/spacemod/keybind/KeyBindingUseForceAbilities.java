...
import net.icanthink.spacemod.procedure.ProcedureOpenForceAbilitiesGui;
import net.icanthink.spacemod.SpaceMod;
import net.icanthink.spacemod.ElementsSpaceMod;

@ElementsSpaceMod.ModElement.Tag
public class KeyBindingUseForceAbilities extends ElementsSpaceMod.ModElement {
	private KeyBinding keys;
	public KeyBindingUseForceAbilities(ElementsSpaceMod instance) {
		super(instance, 12);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.useforceabilities", Keyboard.KEY_GRAVE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureOpenForceAbilitiesGui.executeProcedure($_dependencies);
		}
	}
}

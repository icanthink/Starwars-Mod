...
public class BlockDimentionalReeds extends ElementsSpaceMod.ModElement {
	@GameRegistry.ObjectHolder("spacemod:dimentionalreeds")
	public static final Block block = null;
	public BlockDimentionalReeds(ElementsSpaceMod instance) {
		super(instance, 123);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("spacemod:dimentionalreeds", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == WorldForceDimension.DIMID)
			dimensionCriteria = true;
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("dimentionalreeds");
			setRegistryName("dimentionalreeds");
		}

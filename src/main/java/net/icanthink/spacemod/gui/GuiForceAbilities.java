...
public class GuiForceAbilities extends ElementsSpaceMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiForceAbilities(ElementsSpaceMod instance) {
		super(instance, 10);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.y = y;
			this.z = z;
			this.internal = new InventoryBasic("", true, 109);
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("spacemod:textures/forceabilities.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(1, this.guiLeft + 91, this.guiTop + 57, 70, 20, "Copy Last"));
		}

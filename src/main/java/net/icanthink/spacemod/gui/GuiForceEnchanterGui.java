...
public class GuiForceEnchanterGui extends ElementsSpaceMod.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiForceEnchanterGui(ElementsSpaceMod instance) {
		super(instance, 70);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 17 + 8 + sj * 18, 14 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 17 + 8 + si * 18, 14 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("spacemod:textures/forceenchantergui.png");
		@Override

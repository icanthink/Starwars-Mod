...
public class GuiForceGhostGui extends ElementsSpaceMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiForceGhostGui(ElementsSpaceMod instance) {
		super(instance, 63);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("spacemod:textures/forceghostgui.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				ProcedureForceProjection.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{

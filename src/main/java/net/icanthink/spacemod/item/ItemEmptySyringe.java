...
public class ItemEmptySyringe extends ElementsSpaceMod.ModElement {
	@GameRegistry.ObjectHolder("spacemod:emptysyringe")
	public static final Item block = null;
	public ItemEmptySyringe(ElementsSpaceMod instance) {
		super(instance, 43);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("spacemod:emptysyringe", "inventory"));
	}

...
public class ItemForceXp extends ElementsSpaceMod.ModElement {
	@GameRegistry.ObjectHolder("spacemod:forcexp")
	public static final Item block = null;
	public ItemForceXp(ElementsSpaceMod instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("spacemod:forcexp", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureForceXpRightClick.executeProcedure($_dependencies);
			}
			return ar;
		}

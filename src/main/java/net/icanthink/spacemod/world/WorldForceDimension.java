...
package net.icanthink.spacemod.world;
...
import net.icanthink.spacemod.procedure.ProcedureForceDimensionPlayerLeavesDimension;
import net.icanthink.spacemod.procedure.ProcedureForceDimensionPlayerEntersDimension;
import net.icanthink.spacemod.item.ItemForceDimension;
import net.icanthink.spacemod.block.BlockTempleStone;
...
public class WorldForceDimension extends ElementsSpaceMod.ModElement {
	public static int DIMID = 6;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("spacemod:forcedimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldForceDimension(ElementsSpaceMod instance) {
		super(instance, 106);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemForceDimension().setUnlocalizedName("forcedimension").setRegistryName("forcedimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension forcedimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("forcedimension", "_forcedimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemForceDimension.block, 0, new ModelResourceLocation("spacemod:forcedimension", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureForceDimensionPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureForceDimensionPlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockTempleStone.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockTempleStone.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("forcedimension_portal");
			setRegistryName("forcedimension_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockTempleStone.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockTempleStone.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockTempleStone.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockTempleStone.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("ocean")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("river")), Biome.REGISTRY.getObject(new ResourceLocation("frozen_ocean")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("deep_ocean")), Biome.REGISTRY.getObject(new ResourceLocation("stone_beach")),
				Biome.REGISTRY.getObject(new ResourceLocation("cold_beach")), Biome.REGISTRY.getObject(new ResourceLocation("birch_forest")),
				Biome.REGISTRY.getObject(new ResourceLocation("birch_forest_hills")), Biome.REGISTRY.getObject(new ResourceLocation("roofed_forest")),
				Biome.REGISTRY.getObject(new ResourceLocation("taiga_cold")), Biome.REGISTRY.getObject(new ResourceLocation("taiga_cold_hills")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("mesa_rock")), Biome.REGISTRY.getObject(new ResourceLocation("mesa_clear_rock")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("mutated_plains")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("mutated_ice_flats")), Biome.REGISTRY.getObject(new ResourceLocation("mutated_jungle")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("mutated_mesa")), Biome.REGISTRY.getObject(new ResourceLocation("mutated_mesa_rock")),
				Biome.REGISTRY.getObject(new ResourceLocation("mutated_mesa_clear_rock")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
